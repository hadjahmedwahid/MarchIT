...
<div class="agile-grids">	
 		...
 		<h2 id="forms-example" class="">Nouveau Fournisseur</h2>
 		<form action="fellah.php" method="post">
  <div class="form-group">
    <label for="exampleInputEmail1">Nom :</label>
    <input class="form-control" name ="nomfour" id="exampleInputEmail1" placeholder="....." type="text">
  </div>
